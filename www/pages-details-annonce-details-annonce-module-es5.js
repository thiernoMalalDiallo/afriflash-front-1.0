...
var DetailsAnnoncePageRoutingModule = /** @class */ (function () {
    function DetailsAnnoncePageRoutingModule() {
    }
    ...
    return DetailsAnnoncePageRoutingModule;
}());
...
var DetailsAnnoncePageModule = /** @class */ (function () {
    function DetailsAnnoncePageModule() {
    }
    ...
    return DetailsAnnoncePageModule;
}());
...
var DetailsAnnoncePage = /** @class */ (function () {
    function DetailsAnnoncePage(route, httpAnnonce) {
        this.route = route;
        this.httpAnnonce = httpAnnonce;
    }
    DetailsAnnoncePage.prototype.ngOnInit = function () {
        var _this = this;
     ...
     */
    DetailsAnnoncePage.prototype.ionViewWillEnter = function () {
     ...
     */
    DetailsAnnoncePage.prototype.loadAnnonce = function (id) {
        return this.httpAnnonce.getById('annonce/' + id);
    };
    DetailsAnnoncePage.prototype.actualize = function () {
        this.annonceInformation = null;
    };
    DetailsAnnoncePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-details-annonce-details-annonce-module-es5.js.map