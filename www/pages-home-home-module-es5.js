...
var HomePage = /** @class */ (function () {
    function HomePage(OAuth, modalCtrl, dataProvider, config, sanitizer, navCtrl, session) {
        this.OAuth = OAuth;
     ...
     * Publier une annonce
     */
    HomePage.prototype.publish = function () {
    ...
    HomePage.prototype.goToPage = function (categoryValue) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.session.setItem('source', 'home')];
                    case 1:
                        _a.sent();
                        this.navCtrl.navigateForward('search-annonce', {
